...
在代码中通过[AuthUtils](/ss/util/AuthUtils.java)相关方法使用token
...
更多配置（如token格式，获取方式，校验方式等）请参考[Shiro-Starter](https://github.com/taccisum/shiro-starter)相关文档，在[ShiroConfiguration](/ss/config/ShiroConfiguration.java)中进行配置。
